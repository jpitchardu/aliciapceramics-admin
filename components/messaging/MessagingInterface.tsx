...
export function MessagingInterface({ orderId }: MessagingInterfaceProps) {
  const { status, data: conversation, error, refresh } = useConversation(orderId)
  ...
  if (status === 'error') {
    return (
      <Box flex={1} justifyContent="center" alignItems="center" backgroundColor="primary50" padding="l">
        <Text variant="heading" color="alert600" textAlign="center" marginBottom="m">
    ...
    return (
      <Box flex={1} backgroundColor="primary50">
        <Box flex={1} justifyContent="center" alignItems="center" padding="l">
          <Text variant="body" color="neutral600" textAlign="center" marginBottom="l">
            No conversation started yet. Send your first message to the customer!
          </Text>
        </Box>
